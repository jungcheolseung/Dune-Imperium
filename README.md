...
v61이며 기본 룰셋은 3,521개, CHOAM 룰셋은 3,748개다. 전체 테스트 616개, Ruff,
mypy가 통과한다.

코어 엔진은 여러 라운드를 진행하고 replay할 수 있지만, 공개 random runner와
`dune_imperium_uprising_v0` PettingZoo adapter는 여전히 한 라운드를 실행 단위로
삼는다. Intrigue는 effect DSL 기반 Plot 16종만 play할 수 있고 Leader 능력은 아직
...
- 현재 81개 정수 관측과 v61 action catalog 이후의 전체 게임 관측 확장 및 최종
