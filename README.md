...
- 사람용 UI의 세부 화면·조작 설계(형태는 로컬 웹 UI로 확정, 2026-08-30;
  구현 순서도 M11을 M9·M10보다 앞으로 조정했다. 2026-08-31에 효과 정보
  전면 표시 — 보드 공간 패널, 카드 popover와 로컬 이미지, 행동 효과
  미리보기 — 를 추가했고, 그 이상의 화면 개선은 여전히 열려 있다)
