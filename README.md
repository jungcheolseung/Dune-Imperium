...
2026-08-27 기준으로 기본 보드 시스템, multi-round 상태 전이와 개인 덱 reshuffle,
49종의 기본 Imperium 카드 play data가 구현되어 있다. 기본 룰셋의 Imperium 카드
50종 중 남은 카드는 `Subversive Advisor`다.
현재 action codec은 v54·3,326개이며 전체 테스트 528개, Ruff, mypy가
통과한다.
...
- 현재 81개 정수 관측과 v54 action catalog 이후의 전체 게임 관측 확장 및 최종
