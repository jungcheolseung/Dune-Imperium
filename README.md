...
v71이며 기본 룰셋은 3,923개, CHOAM 룰셋은 4,169개다. 전체 테스트 668개, Ruff,
mypy가 통과한다.
...
삼는다. Intrigue 44장은 39개 identity 전부가 effect DSL로 play되어 완결됐고,
Leader 능력은 아직 구현 전이므로 완전한 기본 게임이나 학습 환경이 끝난 상태는
아니다.
