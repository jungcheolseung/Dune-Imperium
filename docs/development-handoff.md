...
**heuristic 항목은 다시 열렸다.** 16절(g)의 (2) tile 가치표는 기각했고(17절), (1) Tech 전용 표 재설계는
**재정비 표 자체의 상위 세 칸이 틀렸다**는 발견으로 끝나 표 하나를 전 룰셋에 쓰게 바꿨다(18절). 그 마감
측정 두 가지가 미완이라 **다음 세션의 첫 작업**이다(아래 0번).
