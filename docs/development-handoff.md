...
- 다음: 그 문서 7.6 — Mac mini에서 5081 census, 어긋나는 열의 정책 탐침, 평가 문제집 첫 문항(막판 battle-icon Intrigue, sandworm,
  Shield Wall), Guild·Emperor 스타일 봇.
