...
- **기준선 12셀 재측정**(같은 명령, HEAD `f7b73a9`; [evaluation/baseline-2026-09-16.md](evaluation/baseline-2026-09-16.md)
  ...
  Immortality 99, 전 확장 97; 미러 셋 25.0%; rollout(13절 기본값) vs tie-break heuristic 3은 base 44.0 → **42.0%**, 전 확장
  55.0 → **60.0%**. README의 수치를 갱신했다.
