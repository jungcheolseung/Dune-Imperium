...
- **탐색 기본은 후보 5 × 세계 8(2026-09-25 새벽)**(16절): 손잡이 비교(각 400판, 같은 판의 `search:5081`과 짝)에서 후보 5개
  ...
  세계 16은 세계 8보다 +5.0%p [+0.0, +10.0](400판)에 비용 2배 — 올릴지는 사용자 결정(새 판 1,000판 확인 결과는 `knobs/progress.log`).
