...
**현재 위치(2026-09-26).** 카드·보드 전사 전수 감사로 규칙 약 130건(기본판 카드 포함)이 바뀌었다(codec v108, 관측 v20;
아래 "2026-09-26 카드·보드 전사 전수 감사" 세션 요약). **OQ-064·065·066·068·069가 OPEN으로 사용자 판정을 기다린다** — 학습·비교를
다시 시작하기 전에 받는 것이 좋다. 그 뒤 M10은 새 규칙에서 기준선(heuristic·5081·탐색 좌석)부터 다시 잰다. 아래 UI·학습 항목은 그대로다.
...
0. (**2026-09-26 주의 — 규칙이 다시 넓게 바뀌었다**: 카드·보드 전수 감사의 규칙 수정 약 130건(The Spice Must Flow·Covert Operation·Subversive Advisor 등 기본판 카드 포함), codec v108. 5081을 포함한 모든 체크포인트·대전 표·탐색 비교·문제집 채점은 옛 규칙의 것이다. 형식 2 체크포인트는 v108로 이관된다(5081: 유지 32,980·새 24·삭제 7).)
