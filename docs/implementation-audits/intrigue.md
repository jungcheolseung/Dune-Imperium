...
| Conditions | `InfluenceAtLeast`, `HasHighCouncil`, `SpiesPlacedAtLeast`, `CompletedContractsAtLeast`, `SandwormsInConflictAtLeast`, `GainedSpiceThisTurn` |
...
Remaining Intrigue identities (8) have setup identity only and are not
offered for play.
