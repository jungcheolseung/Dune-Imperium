...
| RL encoding | Every physical Prepare the Way copy can take its printed Agent destinations, including Infiltrate variants. | The fixed catalog grows from 554 actions in codec v6 to 754 in v7. |
...
- The 65-card base Imperium manifest still has identity and acquisition-cost
  data only. Drawing one of those cards fails explicitly until its play data is
  transcribed.
