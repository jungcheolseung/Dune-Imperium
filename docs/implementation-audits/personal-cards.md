...
- The two printed card images linked by the Reserve content manifest were
  ...
  Reveal values.
- These twenty-seven shared cards were bootstrapped from DIU `imperium.JSON` at
...
- All shared Imperium cards other than the twenty-seven listed above still have only
