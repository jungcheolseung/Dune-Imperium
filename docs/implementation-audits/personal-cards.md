...
| RL encoding | Every transcribed physical card copy can take its Agent destinations, including Infiltrate variants. | Imperium batches grow the catalog through 832 in v8, 845 in v9, 857 in v10, 971 in v11, 991 in v12, 1001 in v13, 1014 in v14, 1060 in v15, 1068 in v16, 1114 in v17, 1133 in v18, 1146 in v19, 1162 in v20, 1196 in v21, 1200 in v22, 1277 in v23, and 1328 in v24. |
...
- The two printed card images linked by the Reserve content manifest were
  ...
  Reveal values.
- These eighteen shared cards were bootstrapped from DIU `imperium.JSON` at
...
- All shared Imperium cards other than the eighteen listed above still have only
