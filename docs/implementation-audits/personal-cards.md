...
| RL encoding | Every transcribed physical card copy can take its Agent destinations, including Infiltrate variants. | Imperium batches grow the catalog through 832 in v8, 845 in v9, 857 in v10, 971 in v11, 991 in v12, 1001 in v13, 1014 in v14, 1060 in v15, 1068 in v16, and 1114 in v17. |
...
- The two printed card images linked by the Reserve content manifest were
  ...
  Reveal values.
- These eleven shared cards were bootstrapped from DIU `imperium.JSON` at
...
- All shared Imperium cards other than the eleven listed above still have only
