...
5. 카드 play data: Tleilaxu 18 + 프로모 Piter, Imperium 25종(27장), Intrigue 11장 — 전사표 기준으로 `Play`/`Document` 쌍. 새 효과: Research·Tleilaxu·specimen 아이콘, genetic marker 조건, Combat 아이콘 재사용, "lose troops" 비용, Tleilaxu Master의 조건부 획득, Shadout Mapes의 Reveal 배치/retreat, Stillsuit Manufacturer의 hand 반환, Imperium Ceremony의 Intrigue peek. **진행(2026-09-08): 5a Intrigue 11장, 5b-1 Imperium 15종 완료(codec v97); 남은 것은 Imperium 8종(5b-2)과 Tleilaxu 9 + Piter(5c).**
