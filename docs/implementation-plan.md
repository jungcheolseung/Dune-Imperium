...
claim), 슬라이스 2(snapshot + 증분 로그 + gzip), 슬라이스 3(SSE 초인종 + presence + 폴링 fallback)이 끝났고 다음은 슬라이스 4
(클라이언트 원격 UX: 좌석 고르기·이름, 내 좌석 고정, 대기·접속 표시, 호스트 패널)다.
