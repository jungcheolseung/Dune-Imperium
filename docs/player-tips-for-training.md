...
`scripts/ab/tip_census.py`를 넣었다(7절). 이어갈 때는 **7.6 "다음"**부터 시작한다.
...
Mac 스크립트의 seed·정의를 이 노트북에서 볼 수 없어 **원인은 미확정**이다(최종 Fremen ≥ 2로 세어도 87%라 정의 차이로는 설명되지
않았다). 그래서 6.2·6.3의 5081 대 heuristic 비교는 **두 팔 모두 이 도구로 다시** 낸다.
