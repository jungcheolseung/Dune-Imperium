...
FAQ의 새 항목(`*` 표시) 세 개 — Chani (Leader), False Orders, Litany Against Fear — 는
모두 Bloodlines 구성물을 다룬다(False Orders의 Spy 이동 목적지는 OQ-036 (b)로 반영). Skill tile, Tech tile, 카드의 인쇄 텍스트는
