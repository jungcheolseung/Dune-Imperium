...
**남은 것** — 이번 범위 밖에서 본 것:
1. **용어집에 행이 없는 로그 낱말.** Other Memories, Secret Project, set-aside, Wild card, Immediate, Usurp —
   ...
   `[Main p. 11]`, Family Atomics → 가문 핵 토큰 `[Immortality p. 12]`을 한국어 룰북에서 찾아 옮겼다.
