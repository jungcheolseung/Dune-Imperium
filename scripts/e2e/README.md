...
/tmp/dune-e2e-venv/bin/python board_tokens.py  # 약 10초; 인쇄된 자리에 놓이는 조각(Control·bonus spice·Maker Hooks·Alliance)과 Reveal 미리보기·Intrigue 더미
