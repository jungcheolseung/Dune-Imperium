...
IMPERIUM_CARDS: Final = (
    ...
    _entry(91, "command-center", "Command Center", 3, bloodlines_only=True),
    _entry(
        92,
        "corrupt-bureaucrat",
        "Corrupt Bureaucrat",
    ...
    _entry(95, "disruption-tactics", "Disruption Tactics", 2, bloodlines_only=True),
    _entry(96, "eliminate-allies", "Eliminate Allies", 2, bloodlines_only=True),
    _entry(97, "elite-forces", "Elite Forces", 3, bloodlines_only=True),
    _entry(98, "engineered-miracle", "Engineered Miracle", 3, bloodlines_only=True),
    _entry(99, "fremen-war-name", "Fremen War Name", 4, bloodlines_only=True),
    _entry(100, "holy-war", "Holy War", 5, bloodlines_only=True),
    _entry(101, "i-believe", "I Believe", 3, bloodlines_only=True),
    _entry(
        102,
        "imperial-throneship",
        "Imperial Throneship",
    ...
    _entry(77, "pointing-the-way", "Pointing the Way", 6, bloodlines_only=True),
    _entry(
        78,
        "possible-futures",
        "Possible Futures",
    ...
    _entry(80, "quash-rebellion", "Quash Rebellion", 5, copies=2, bloodlines_only=True),
    _entry(82, "sandwalk", "Sandwalk", 1, copies=2, bloodlines_only=True),
    _entry(83, "sardaukar-standard", "Sardaukar Standard", 4, bloodlines_only=True),
    _entry(86, "shrouded-counsel", "Shrouded Counsel", 4, bloodlines_only=True),
