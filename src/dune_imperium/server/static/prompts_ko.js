...
const PROMPT_KO = {
  ...
  "Choose a card to discard for Covert Operation": "비밀 작전 효과로 버릴 카드 선택",
  ...
  "Gain two Persuasion or pay one Water for a sandworm": "{persuasion} 2 획득 또는 {water} 1 지불하고 {sandworm} 획득",
